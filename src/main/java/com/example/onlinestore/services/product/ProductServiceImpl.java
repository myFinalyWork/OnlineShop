...
public class ProductServiceImpl implements ProductService {
    ...
    @Override
    public List<ProductServiceModel> findProductByName(String name) {
        List<ProductServiceModel> productServiceModels  = this.productRepository.findAllByName(name)
                .stream()
                .map(product1 -> this.modelMapper.map(product1,ProductServiceModel.class))
